...
#include "SurvivorTabActionComponent.h"
...
USurvivorTabActionComponent::USurvivorTabActionComponent()
{
...
void USurvivorTabActionComponent::TabPressed()
{
...
void USurvivorTabActionComponent::TabReleased()
{
	Super::TabReleased();
}
